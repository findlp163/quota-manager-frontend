...
const handleQueryUser = async () => {
  ...
  try {
    ...
    const res = await quotaCheckPermissionApi.getUserQuotaCheckSetting(queryUserForm.userId)
...
const handleSetUser = async () => {
  try {
    ...
    await quotaCheckPermissionApi.setUserQuotaCheckSetting(setUserForm.userId, setUserForm.enabled)
...
const handleQueryDept = async () => {
  ...
  try {
    ...
    const res = await quotaCheckPermissionApi.getDepartmentQuotaCheckSetting(queryDeptForm.departmentName)
...
const handleSetDept = async () => {
  try {
    ...
    await quotaCheckPermissionApi.setDepartmentQuotaCheckSetting(setDeptForm.departmentName, setDeptForm.enabled)
    ElMessage.success('Saved successfully')
  } catch (e) {
  } finally {
